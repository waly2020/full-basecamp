        ...
        <div className="w-screen h-screen flex justify-center items-center flex-col">
           <h1 className="font-bold text-4xl mb-5 uppercase">Add new project</h1>
            <form onSubmit={onCreateProject} className="w-full max-w-[500px] px-3 py-5 flex flex-col gap-5 shadow-lg rounded">
                <InputIcons ref={nameRef} placeholder="Project name..."/>
                <textarea ref={descriptionRef} className="resize-none bg-gray-100 rounded p-3 min-h-[200px] outline-gray-300" placeholder="Project description..."/>
